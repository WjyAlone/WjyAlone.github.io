var 引流 = [
  "https://space.bilibili.com/3546374278744508?spm_id_from=333.337.0.0"
]
...
function onModelLoad(model) {
  ...
  if (modelNmae === "Diana") {
    ...
    initConfig.content.skin[1] = ["我是吃货担当~~"]
    ...
    initConfig.content.skin[1] = ["我是<s>拉胯</s>Gamer担当 piecer AvA~"]
    playAction({
      motion: "Tap左眼",
      from: {
        "Part15": 1
